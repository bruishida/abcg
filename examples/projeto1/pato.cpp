...
void Pato::initializeGL(GLuint program) {
  terminateGL();
...
void Pato::paintGL(const GameData &gameData) {
...
void Pato::update(const GameData &gameData, float deltaTime) {
  // Rotate
